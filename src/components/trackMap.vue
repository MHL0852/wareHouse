...
import wareUrl from '../assets/images/icon_qzc.png'
import vehicleUrl from '../assets/images/icon_qs.png'
...
export default {
  ...
  methods: {
    ...
    initMap(){
      ...
      const wareIcon = new BMap.Icon(wareUrl, new BMap.Size(30,32));
      const vehicleIcon = new BMap.Icon(vehicleUrl, new BMap.Size(30,30));
